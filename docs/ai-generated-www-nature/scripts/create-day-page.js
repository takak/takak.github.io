...
<head>
  ...
  <title>Day ${sceneData.metadata.dayNumber}: ${seasonInfo.seasonEmoji} ${seasonInfo.season} - Nature Garden</title>
  <style>
    body {
      margin: 0;
      padding: 20px;
...
<body>
  <h1>🌳 Nature Garden - Day ${sceneData.metadata.dayNumber}</h1>
